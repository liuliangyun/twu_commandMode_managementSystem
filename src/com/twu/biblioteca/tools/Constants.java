...
public class Constants {
    ...
    public static final String WELCOME_INFO = "Welcome to The Bangalore Public Library!\n";
    public static final String SPLIT_LINE = "------------------------------------------\n";
    public static final String MENU_TITLE = "       Main Menu       \n";
    public static final String LIST_BOOK_OPTION = "List Books, please press 1.\n";
    public static final String CHECKOUT_BOOK_OPTION = "Checkout Book, please press 2.\n";
    ...
    public static final String EXIT_INFO ="Exit the Bangalore Public Library!\n";
    public static final String WARN_INFO ="Select a valid option!\n";
